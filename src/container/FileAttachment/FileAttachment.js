...
const FileAttachment = () => {
  ...
  const baseURL = "http://51.20.128.98";
  ...
  const handleFileChange = async (event) => {
    ...
    try {
      ...
      const updatedFiles = [...attachfile, newFile];
      dispatch(storeFiles(updatedFiles));
  ...
  return (
    <>
      ...
      <Card className="mb-3 shadow-sm border-0">
        ...
        <Card.Body>
          <Table bordered size="sm" className="mb-0" style={{ maxHeight: '80vh', overflowY: 'auto' }}>
